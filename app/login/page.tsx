  ...
  return (
    <div className={`min-h-screen w-full flex items-center justify-center bg-zinc-950 relative overflow-hidden select-none`}>
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        <div className={`absolute top-[-10%] left-[-10%] w-[40%] h-[40%] ${theme.classes.glow} rounded-full blur-[120px] animate-pulse`} />
        <div className={`absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] ${theme.classes.glow} rounded-full blur-[120px] animate-pulse delay-1000`} />
      </div>
      ...
      >
        <Card className={`${theme.classes.bgSecondary}/60 backdrop-blur-2xl ${theme.classes.border} border shadow-2xl`}>
          <CardHeader className="space-y-3 text-center pb-8 pt-6">
            ...
            <CardTitle className={`text-3xl font-bold tracking-tight ${theme.classes.text}`}>{appName}</CardTitle>
        ...
        <p className={`mt-8 text-center text-[10px] uppercase tracking-widest ${theme.classes.textSecondary} font-medium`}>
          {appName} Security Systems Protected
        </p>
      </motion.div>
    </div>
  );
